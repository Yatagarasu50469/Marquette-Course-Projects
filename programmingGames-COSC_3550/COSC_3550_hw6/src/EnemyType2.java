...
public class EnemyType2 extends GameObj {
	int size = 0;
	int maxVelChange = 30;
    ...
    int maxTimeToFire = 4; //Maximum additional time to fire
	
	EnemyType2(Group primaryGroup, double winWidth, double winHeight, double startX, double startY) {
