...
%-------------------------------------------------------------------------------------------------
funcName = 'Bulkin-N.6'; %Name of the function being used
testNum = 0; %Test number; For figure development; Must manually increment
%Input constant variables; if applicable
func = @(x,y) 100.*sqrt(abs(y-0.01.*(x.^2)))+0.01.*(x+10); %Input function
...
maxMinXYmesh = 15; %Mesh x,y limits for plot; min is negative
