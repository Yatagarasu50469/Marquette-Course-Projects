...
HD_PWD='C:/Users/Yatagarasu/control_unit/control_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Control_Unit_tb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Control_Unit_tb.tcl
