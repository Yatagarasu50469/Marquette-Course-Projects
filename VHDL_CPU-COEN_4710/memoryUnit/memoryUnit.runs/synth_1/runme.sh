...
HD_PWD='C:/Users/Yatagarasu/memoryUnit/memoryUnit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoryUnit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source memoryUnit.tcl
