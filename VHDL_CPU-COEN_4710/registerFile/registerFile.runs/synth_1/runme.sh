...
HD_PWD='C:/Users/Yatagarasu/registerFile/registerFile.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fileRegister.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fileRegister.tcl
