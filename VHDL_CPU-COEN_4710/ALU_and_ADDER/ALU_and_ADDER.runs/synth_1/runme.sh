...
HD_PWD='C:/Users/Ben/Desktop/HardwareProject2/registerFile/registerFile.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log thirtytwobit_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source thirtytwobit_adder.tcl
